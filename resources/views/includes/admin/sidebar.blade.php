...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">{{ Auth::user()->name }} - {{ count(App\Models\Status::where('user_id', $item->id)->get()) > 0 ? App\Models\Status::where('user_id', $item->id)->orderBy('updated_at', 'desc')->get()[0]->status == 'masuk' ? 'Aktif' : 'Keluar' : ''}}</a>
            </div>
        </div>
